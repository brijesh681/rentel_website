...
class ProductDisplaySerializer(serializers.ModelSerializer):
    class Meta:
        model= Product
        fields = ["name","product_image1","product_image2","product_image3","product_image4","product_image5","product_mrp","size","rental_mrp","is_available_for_rent","is_stock","id","brand","category","material","product_mrp"]
...
class BagProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['name', 'product_image1', 'product_mrp', 'rental_mrp', 'security_deposit']